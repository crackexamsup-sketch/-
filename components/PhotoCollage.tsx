...
const rawPhotos = [
  { url: 'https://i.ifh.cc/xmWG3H.jpg', caption: '사랑하는 가족' },
  { url: 'https://i.ifh.cc/JvdSbV.jpg', caption: '소중한 추억' },
  { url: 'https://i.ifh.cc/kzDC68.jpg', caption: '아름다운 미소' },
  { url: 'https://i.ifh.cc/N6FTJh.jpg', caption: '함께한 세월' },
  { url: 'https://i.ifh.cc/23tPH6.jpg', caption: '따뜻한 품' },
  { url: 'https://i.ifh.cc/7G2NW1.jpg', caption: '은혜로운 삶' },
  { url: 'https://i.ifh.cc/2gDKSn.jpg', caption: '행복한 순간' },
  { url: 'https://i.ifh.cc/J3tFFD.jpg', caption: '건강하세요' },
  { url: 'https://i.ifh.cc/aDOoHq.jpg', caption: '영원한 사랑' },
  { url: 'https://i.ifh.cc/t3QpLb.jpg', caption: '꽃보다 고운 당신' },
  { url: 'https://i.ifh.cc/VpC7zR.jpg', caption: '기억의 조각' },
  { url: 'https://i.ifh.cc/Hhb79h.jpg', caption: '빛나는 날들' },
  { url: 'https://i.ifh.cc/PgvZ93.jpg', caption: '감사합니다' },
  { url: 'https://i.ifh.cc/s8aAXq.jpg', caption: '존경합니다' },
  { url: 'https://i.ifh.cc/JN4rLs.jpg', caption: '축복합니다' },
  { url: 'https://i.ifh.cc/6FRgmk.jpg', caption: '나의 할머니' },
  { url: 'https://i.ifh.cc/VYYX0T.jpg', caption: '따스한 햇살' },
  { url: 'https://i.ifh.cc/yl2chP.jpg', caption: '아름다운 동행' },
  { url: 'https://i.ifh.cc/56vCnS.jpg', caption: '사랑합니다' },
  { url: 'https://i.ifh.cc/7l0OwY.jpg', caption: '희망찬 내일' },
  { url: 'https://i.ifh.cc/AtP6D3.jpg', caption: '포근한 미소' },
  { url: 'https://i.ifh.cc/CQJ8kw.jpg', caption: '가족의 힘' },
  { url: 'https://i.ifh.cc/cVbZkJ.jpg', caption: '빛나는 순간' },
  { url: 'https://i.ifh.cc/QnPDYb.jpg', caption: '사랑의 기억' },
  { url: 'https://i.ifh.cc/hMn0xf.jpg', caption: '고마운 당신' },
  { url: 'https://i.ifh.cc/TnFrVz.jpg', caption: '축복의 시간' },
  { url: 'https://i.ifh.cc/Q6XAf6.jpg', caption: '함께 웃어요' },
  { url: 'https://i.ifh.cc/NhLt1o.jpg', caption: '아름다운 인생' },
  { url: 'https://i.ifh.cc/2yyFct.jpg', caption: '영원히 함께' }
];
